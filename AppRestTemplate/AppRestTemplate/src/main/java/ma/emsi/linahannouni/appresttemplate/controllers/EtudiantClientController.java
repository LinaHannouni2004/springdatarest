package ma.emsi.linahannouni.appresttemplate.controllers;

import ma.emsi.linahannouni.appresttemplate.services.EtudiantClientService;
...
public class EtudiantClientController {
    ...
    @GetMapping("/{p}/{s}/{t}") //http://localhost:8083/etudiants/0/2/nom,desc
